<div class="row">
    <div class="col-md-7">
	    ...
	    in cooperation with the Nepal Center for Contemporary Research,
            ...
            Agency for Development and Cooperation (SDC) and the institutions participating
            in the NCCR North-South is gratefully acknowledged. For further information
            on the project, please consult: <a class="external" href=" http://www.north-south.unibe.ch/content.php/page/id/317">http://www.north-south.unibe.ch</a>.
        </p>
    </div>
</div>
<div class="row">
